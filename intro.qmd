...
![Transition dynamics between neighboring states](figures/fig_intro_2){#fig-transition-neighboring}
...
![The traveling salesman has to find a good and practical solution](figures/fig_intro_3){#fig-tsp-1}
...
location $i$ and $j$ (for consistency assume $c_{ii}=0$). Now we want to minimize the distance. For this we write:
