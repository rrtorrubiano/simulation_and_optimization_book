...
Instead of that, we sample from a probability distribution where markt crashes are common.
...
get a high weight, whereas rare samples will be assigned a low weight. 
...
the **stationary distibution** is itself the distribution we want to sample from.
