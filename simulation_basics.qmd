...
approaches that we will see in the rest of the book: **Markov chain**. A Markov chain is a stochastic process that
...
the time parameter can be either *discrete* or *continuous*.
